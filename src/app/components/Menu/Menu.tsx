...
const Menu = (props: MenuProps) => {
  ...
  return (
    <HMenu as="div" className="relative inline-block text-left">
      ...
      >
        <HMenu.Items
          className="w-26 absolute right-0 mt-2 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
        >
          <div className="p-1">
            {/*{children}*/}
          </div>
